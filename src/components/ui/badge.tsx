  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        pendingReview: "border-transparent bg-yellow-100 text-yellow-700",
        approved: "border-transparent bg-green-100 text-green-700",
        finalised: "border-transparent bg-purple-100 text-purple-700",
        // Severity variants
        ...
        // Condition variants
        good: "border-transparent bg-green-100 text-green-700",
